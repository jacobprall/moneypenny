...
Moneypenny exposes its full surface area as an MCP server. Add it to your
MCP-compatible client so you can interact through natural language instead of
...
Once connected, every operation below can be performed by asking your agent in
plain English. The following steps show both ways.

## 5. Add Some Knowledge
