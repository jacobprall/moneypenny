...
<Aside type="tip">
  ...
  no piping JSON — just add the server config and start talking.
</Aside>

### Configuring Moneypenny as an MCP Server
...
Once configured, the client discovers Moneypenny's tools on startup. You can
...
Moneypenny integrates with OpenClaw as the intelligence/data plane:

- **OpenClaw** handles execution (channels, nodes, browser automation, webhooks)
- **Moneypenny** handles intelligence (memory, policy, audit, retrieval, sync)
