...
Account.create(debit: false, account_category: 'Loan', institution: 'US Bank', label: 'Mortgage', balance: 124000, user_id: 1)
Account.create(debit: false, account_category: 'Loan', institution: 'Other', label: 'Student Loans', balance: 14000, user_id: 1)
Account.create(debit: false, account_category: 'Credit Card', institution: 'American Express', label: 'Amex Travel', balance: 576.90, user_id: 1)
