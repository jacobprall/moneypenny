import { definePrompt, type AnthropicToolDef, type Prompt } from "@mp/ctx";
import { getConfig, getConversation, listSkillCatalog } from "@mp/db";

const DEFAULT_SYSTEM_INSTRUCTIONS = [
  "You are Moneypenny, an expert AI coding assistant running locally against the user's repository.",
  "",
