...
The reasons for this refactoring are the same as for [Split Temporary Variable](/split-temporary-variable), but in this case we're dealing with a parameter, not a local variable.
